...
import '../config/api_config.dart'; // ← IMPORT API CONFIG
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  // ── FIX: Helper untuk build URL foto yang benar menggunakan ApiConfig ──────
  ...
  Future<void> _loadUserData() async {
    ...
    if (widget.userData != null) {
      ...
      _descriptionCtrl.text = widget.userData!['description'] ??
          ...
          widget.userData!['bio'] ??
          '';
      _currentPhotoUrl = _buildPhotoUrl(widget.userData!['profile_photo'] ?? widget.userData!['avatar']);
    ...
    setState(() {
      if (userData != null) {
        ...
        if (_currentPhotoUrl == null || _currentPhotoUrl!.isEmpty) {
          _currentPhotoUrl = _buildPhotoUrl(userData['profile_photo'] ?? userData['avatar']);
        }
  ...
  Widget _photoOption(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: color.withValues(alpha: 0.08), // ← FIX: ganti withOpacity
          borderRadius: BorderRadius.circular(12),
        ),
        child: Column(
          children: [
      ...
      child: Column(
        children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF1A4B84).withValues(alpha: 0.3), // ← FIX
                        blurRadius: 15,
          ...
          Text(
            ...
            style: GoogleFonts.inter(
              fontSize: 12,
              color: const Color(0xFF424750).withValues(alpha: 0.6), // ← FIX
            ),
          ),
          if (_selectedPhotoBytes != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.green.withValues(alpha: 0.1), // ← FIX
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: Colors.green.withValues(alpha: 0.3)), // ← FIX
              ),
              child: Text(
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.inter(
              fontSize: 13,
              color: const Color(0xFF424750).withValues(alpha: 0.5), // ← FIX
            ),
            filled: true,
