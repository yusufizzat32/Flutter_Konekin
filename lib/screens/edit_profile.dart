  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      if (userData != null) {
        ...
        if (_bioCtrl.text.isEmpty) _bioCtrl.text = userData['bio'] ?? '';
        if ((_currentPhotoUrl == null || _currentPhotoUrl!.isEmpty)) {
          _currentPhotoUrl = userData['profile_photo'] ?? userData['avatar'] ?? '';
        }
        if (_businessNameCtrl.text.isEmpty) _businessNameCtrl.text = userData['business_name'] ?? '';
        if (_businessAddressCtrl.text.isEmpty) _businessAddressCtrl.text = userData['address'] ?? '';
      }
      _isLoading = false;
    });
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _photoOption(Icons.camera_alt_rounded, 'Kamera', const Color(0xFF1A4B84), () {
                  Navigator.pop(context);
                  _pickPhoto(ImageSource.camera);
                }),
                _photoOption(Icons.photo_library_rounded, 'Galeri', const Color(0xFF006D77), () {
                  Navigator.pop(context);
                  _pickPhoto(ImageSource.gallery);
                }),
                if (_selectedPhotoBytes != null || (_currentPhotoUrl != null && _currentPhotoUrl!.isNotEmpty))
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    hint: 'Ceritakan tentang bisnis UMKM Anda...',
