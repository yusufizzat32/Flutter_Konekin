...
class _ProfileUmkmPageState extends State<ProfileUmkmPage> {
  ...
  // ── Helper build URL foto absolute menggunakan ApiConfig ───────────────────
  ...
  Widget _buildProfileHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: _primaryBlue.withValues(alpha: 0.3), // ← FIX
            blurRadius: 20,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Colors.white.withValues(alpha: 0.2), // ← FIX
                  ),
                  child: ClipOval(
  ...
  Widget _statItem(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.04), // ← FIX
            blurRadius: 8,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: GoogleFonts.inter(
                    fontSize: 12, color: _textMid.withValues(alpha: 0.6)), // ← FIX
                filled: true,
            ...
            _businessDescription.isEmpty
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                          color: _primaryBlue.withValues(alpha: 0.2), // ← FIX
                          style: BorderStyle.solid),
                    ),
                    child: Row(
                      children: [
                        Icon(Icons.info_outline,
                            size: 16, color: _primaryBlue.withValues(alpha: 0.6)), // ← FIX
                        const SizedBox(width: 8),
                        Expanded(
                          child: Text(
                            ...
                            style: GoogleFonts.inter(
                                fontSize: 12,
                                color: _textMid.withValues(alpha: 0.8), // ← FIX
                                height: 1.4),
                          ),
                        ),
                      ],
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: GoogleFonts.inter(
                        fontSize: 12,
                        color: _textMid.withValues(alpha: 0.6)), // ← FIX
                    filled: true,
                    fillColor: const Color(0xFFF5F5F5),
    ...
    return Row(
      children: [
        Container(
          ...
          height: 36,
          decoration: BoxDecoration(
            color: _primaryBlue.withValues(alpha: 0.08), // ← FIX
            borderRadius: BorderRadius.circular(8),
          ),
