...
class _UmkmDashboardState extends State<UmkmDashboard> {
  ...
  // ── status proyek yang butuh pembayaran ──────────────────────────────
  ...
  void initState() {
    ...
    // Load notifikasi dan start periodic refresh untuk UMKM
  ...
  void _showNotificationsScreen() {
    Navigator.push(
      ...
      // Refresh notifikasi saat kembali
      final provider = Provider.of<NotificationProvider>(context, listen: false);
      provider.loadNotifications();
    });
  }
  ...
  PreferredSizeWidget _buildAppBar() {
    ...
    // Dashboard AppBar dengan notifikasi
    return AppBar(
      backgroundColor: Colors.white,
      elevation: 0,
  ...
  // ── Widget notifikasi bell dengan badge dari Provider ─────────────────────
  ...
  // ── Banner proyek yang menunggu pembayaran ───────────────────────────────
